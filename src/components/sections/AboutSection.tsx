  ...
  return (
    <section id="about" className="bg-white py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="About Us"
          title="A boutique flower experience with care in every detail"
          description="Shifa Blooms is crafted for customers who value elegance, freshness, and thoughtful presentation in every bouquet."
        />
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-50 via-white to-emerald-50 p-8 shadow-[0_25px_80px_-45px_rgba(15,23,42,0.28)]">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-xl text-base leading-8 text-stone-600">
                We focus on refined color palettes, premium flower selection, and polished presentation to make every
                order feel special. This section is intentionally placeholder content for the first launch milestone.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-3xl border border-stone-100 bg-stone-50 p-6">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-sage-600">Fresh curation</p>
            ...
            <div className="rounded-3xl border border-stone-100 bg-white p-6 shadow-sm sm:col-span-2">
              <div className="grid gap-4 sm:grid-cols-3">
                {['Soft palette', 'Luxury finish', 'Local service'].map((item) => (
                  <div key={item} className="rounded-2xl bg-stone-50 px-4 py-5 text-center text-sm font-medium text-stone-700">
                    {item}
                  </div>
                ))}
              </div>
